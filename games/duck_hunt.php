    ...
    <main2>
        <div class="box_games">
            ...
            <div class="map">
                ...
                <label class="duck duck1 riffle" for="duck5"></label>

                   
                <input id="duck6" type="checkbox" class="riffle">
                <label class="duck duck2 riffle" for="duck6"></label>

                   
                <input id="duck7" type="checkbox" class="riffle">
                <label class="duck duck3 riffle" for="duck7"></label>

                   
                <input id="duck8" type="checkbox" class="riffle">
                <label class="duck duck4 riffle" for="duck8"></label>

                <input id="duck9" type="checkbox" class="riffle">
                <label class="duck duck1 riffle" for="duck9"></label>
                <div class="count"></div>
